...
ORB_EVAL_ZONES=$(eval echo "$ORB_EVAL_ZONES")
ORB_EVAL_KUBERNETES_VERSION=$(eval echo "$ORB_EVAL_KUBERNETES_VERSION")
ORB_EVAL_CONFIG_FILE=$(eval echo "$ORB_EVAL_CONFIG_FILE")
ORB_EVAL_VPC_PRIVATE_SUBNETS=$(eval echo "$ORB_EVAL_VPC_PRIVATE_SUBNETS")
ORB_EVAL_VPC_PUBLIC_SUBNETS=$(eval echo "$ORB_EVAL_VPC_PUBLIC_SUBNETS")
ORB_EVAL_NODEGROUP_NAME=$(eval echo "$ORB_EVAL_NODEGROUP_NAME")
ORB_EVAL_NODE_TYPE=$(eval echo "$ORB_EVAL_NODE_TYPE")
ORB_EVAL_NODE_AMI=$(eval echo "$ORB_EVAL_NODE_AMI")
ORB_EVAL_NODE_AMI_FAMILY=$(eval echo "$ORB_EVAL_NODE_AMI_FAMILY")
ORB_EVAL_NODE_VOLUME_TYPE=$(eval echo "$ORB_EVAL_NODE_VOLUME_TYPE")
ORB_EVAL_NODE_SECURITY_GROUPS=$(eval echo "$ORB_EVAL_ORB_EVAL_NODE_SECURITY_GROUPS")
ORB_EVAL_NODE_LABELS=$(eval echo "$ORB_EVAL_NODE_LABELS")
ORB_EVAL_NODE_ZONES=$(eval echo "$ORB_EVAL_NODE_ZONES")
ORB_EVAL_SSH_PUBLIC_KEY=$(eval echo "$ORB_EVAL_SSH_PUBLIC_KEY")
ORB_EVAL_VPC_CIDR=$(eval echo "$ORB_EVAL_VPC_CIDR")
ORB_EVAL_VPC_FROM_KOPS_CLUSTER=$(eval echo "$ORB_EVAL_VPC_FROM_KOPS_CLUSTER")
