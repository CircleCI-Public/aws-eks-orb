...
eval echo " CLUSTER NAME $PARAM_CLUSTER_NAME" >> test.txt 
echo " CONFIG FILE $PARAM_CONFIG_FILE
REGION $PARAM_AWS_REGION
PROFILE $PARAM_AWS_PROFILE
WAIT $PARAM_WAIT
CFN ROLE $PARAM_CFN_ROLE_ARN
VERBOSE $PARAM_VERBOSE
WAIT TIME $PARAM_AWS_MAX_POLLING_WAIT_TIME" >> test.txt
