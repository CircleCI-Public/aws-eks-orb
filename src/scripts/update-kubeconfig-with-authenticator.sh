...
ORB_EVAL_KUBECONFIG_FILE_PATH=$(eval echo "$ORB_EVAL_KUBECONFIG_FILE_PATH")
ORB_EVAL_ROLE_ARN=$(eval echo "$ORB_EVAL_ROLE_ARN")
ORB_EVAL_CLUSTER_CONTEXT_ALIAS=$(eval echo "$ORB_EVAL_CLUSTER_CONTEXT_ALIAS")
ORB_EVAL_DRY_RUN=$(eval echo "$ORB_EVAL_DRY_RUN")
